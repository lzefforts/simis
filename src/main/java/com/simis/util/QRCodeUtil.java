...
public class QRCodeUtil {
    ...
    //服务器存放图片的地址
    public static final String LOCAL_PATH = "/Users/ArnoldLee/";
    ...
    public static void main(String[] args) throws Exception {
        //"weixin://wxpay/bizpayurl?pr=qKSv9oc";//"http://www.baidu.com";
        //"https://qr.alipay.com/bax00885xbhszseo9l7p404d";

        String text = "weixin://wxpay/bizpayurl?pr=U2oUpmh";
        //不含Logo
        QRCodeUtil.encode(text, null,LOCAL_PATH, true);
        //含Logo，不指定二维码图片名
