...
import com.simis.util.PayCommonUtil;
...
public class WeiXinPayController {
     ...
     * @return
     */
    @RequestMapping(value = "/weixinPay/{totalAmount}/{description}/{openId}",
    ...
    public SortedMap<String, Object> ToPay(@PathVariable String sn, @PathVariable BigDecimal totalAmount, @PathVariable String description, @PathVariable String openId, HttpServletRequest request) {
        ...
        Long userId = 0L;//baseController.getUserId();
        ...
        finalpackage.put("appId", WeChatPayConstants.WECHAT_APP_ID);
    ...
    public Map<String, String> weixinPrePay(String trade_no, BigDecimal totalAmount,
        ...
        parameterMap.put("appid", WeChatPayConstants.WECHAT_APP_ID);
        parameterMap.put("mch_id", WeChatPayConstants.WECHAT_MCH_ID);
