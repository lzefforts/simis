		...
		showIfameMask: function(setting, showSign) {
			...
			if (showSign) {
				...
				for (var i = 0, l = iframeList.length; i < l; i++) {
					...
					r = tools.getAbs(obj),
					dragMask = $$("<div id='zTreeMask_" + i + "' class='zTreeMask' style='top:" + r[1] + "px; left:" + r[0] + "px; width:" + obj.offsetWidth + "px; height:" + obj.offsetHeight + "px;z-index: 9999;'></div>", setting);
